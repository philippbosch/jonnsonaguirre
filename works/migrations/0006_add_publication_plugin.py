...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PublicationPlugin'
        db.create_table('cmsplugin_publicationplugin', (
            ('issuu_document_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('abstract', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('works', ['PublicationPlugin'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'PublicationPlugin'
        db.delete_table('cmsplugin_publicationplugin')
