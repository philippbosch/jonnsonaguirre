...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('works_work', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=50, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Work.slug'
        db.delete_column('works_work', 'slug')
