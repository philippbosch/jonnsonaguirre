...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WorkPlugin'
        db.create_table('cmsplugin_workplugin', (
            ('work', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['works.Work'])),
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('works', ['WorkPlugin'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'WorkPlugin'
        db.delete_table('cmsplugin_workplugin')
