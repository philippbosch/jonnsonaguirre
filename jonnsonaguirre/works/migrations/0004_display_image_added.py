...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Work.display_image'
        db.add_column('works_work', 'display_image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Work.display_image'
        db.delete_column('works_work', 'display_image')
