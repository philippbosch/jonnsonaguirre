...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MediaFile.order'
        db.add_column('works_mediafile', 'order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'MediaFile.order'
        db.delete_column('works_mediafile', 'order')
